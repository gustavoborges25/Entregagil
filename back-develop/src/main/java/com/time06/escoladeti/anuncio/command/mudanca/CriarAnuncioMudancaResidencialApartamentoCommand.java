...
public class CriarAnuncioMudancaResidencialApartamentoCommand extends CriarAnuncioMudancaResidencialCommand {

    private Integer numeroDoAndar;

    @JsonCreator
    public CriarAnuncioMudancaResidencialApartamentoCommand(
            ...
            @JsonProperty("numeroDoAndar") Integer numeroDoAndar,
