app.controller('apartamentoController', ['$scope', '$location', '$rootScope','$window', '$localStorage', 'apartamentoService',function($scope, $location, $rootScope, $window, $localStorage, apartamentoService){
