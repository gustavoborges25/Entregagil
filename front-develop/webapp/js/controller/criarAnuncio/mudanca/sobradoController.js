app.controller('sobradoController', ['$scope', '$location', '$rootScope','$window', '$localStorage', 'sobradoService',function($scope, $location, $rootScope, $window, $localStorage, sobradoService){
  ...
  $scope.init = function() {
    ...
    $scope.menosAndares = function(){
     if($scope.anuncio.qtdeAndares>1){
         $scope.anuncio.qtdeAndares--;
     }
    }
    $scope.maisAndares = function(){
      if($scope.anuncio.qtdeAndares<5){
          $scope.anuncio.qtdeAndares++;
      }
    }
